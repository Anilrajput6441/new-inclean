...
const page = () => {
  return (
    <div className="pt-40 pb-10 bg-[#F7F7F7] flex flex-col justify-center items-center">
      ...
      <div className="w-[80%] h-[40vh] flex">
        <div className="w-1/2 h-full flex items-center ">
          <h1 className="lato-medium text-3xl">Contact us</h1>
        </div>
        <div className="w-1/2 h-full flex flex-col justify-center">
          <h1 className="lato-medium text-3xl">London, UK</h1>
          <div className="group flex items-center pt-5">
            <a
              href="mailto:INFO@INCLEAN.IN"
              className="underline group-hover:text-cyan-500 lato-light text-3xl"
            >
              INFO@INCLEAN.IN
            </a>
      ...
      <div className="w-[80%] h-[40vh] flex">
        <div className="w-1/2 h-full flex items-center ">
          <h1 className="lato-medium text-3xl">New business</h1>
        </div>
        <div className="w-1/2 h-full flex flex-col justify-center">
          <h1 className="lato-medium text-3xl">
      ...
      <div className="w-[80%] h-[40vh] flex">
        <div className="w-1/2 h-full flex items-center ">
          <h1 className="lato-medium text-3xl">Join us</h1>
        </div>
        <div className="w-1/2 h-full flex flex-col justify-center">
          <h1 className="lato-medium text-3xl">
          ...
          <div className="group flex items-center pt-5">
            <a
              ...
              className="underline hover:text-cyan-500 text-3xl font-light"
            >
              www.inclean.in
            </a>
            <ArrowUpRight className="w-10 h-10 group-hover:rotate-45 group-hover:text-cyan-500 text-black" />
