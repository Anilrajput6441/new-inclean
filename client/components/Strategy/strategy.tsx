...
const Strategy = () => {
  return (
    <div>
      <h1 className="flex flex-col lato-regular2 text-center pt-10 bg-[#F7F7F7]">
        <RevealOnScroll direction="up" delay={0.2}>
          Our Strategy
        </RevealOnScroll>
      </h1>

      <div className="flex w-full  bg-[#F7F7F7] p-5 pt-40">
        <RevealOnScroll direction="up" delay={0.2}>
          <div className="flex">
            <div className="w-1/2 pt-10  h-full ">
              <h1 className="lato-light text-[32px] pl-10">
                Designing & Planning
              </h1>
              <p className="lato-medium text-[22px] pt-5 pl-10 ">
